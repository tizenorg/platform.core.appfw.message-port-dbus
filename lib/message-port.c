...
messageport_register_local_port_with_user_data (const char* local_port, messageport_message_cb callback, void *user_data)
{
    ...
    int local_port_id = _messageport_register_port (local_port, FALSE, callback);
    if (local_port_id > 0)
    {
...
{
    return messageport_register_local_port_with_user_data(local_port, callback, NULL);
}
...
messageport_register_trusted_local_port_with_user_data (const char *local_port, messageport_message_cb callback, void *user_data)
{
    ...
    int trusted_local_port_id = _messageport_register_port (local_port, TRUE, callback);
    ...
    return (messageport_error_e)trusted_local_port_id;
}

messageport_error_e
messageport_register_trusted_local_port (const char *local_port, messageport_message_cb callback)
{
    return messageport_register_trusted_local_port_with_user_data(local_port, callback, NULL);
}
...
messageport_check_remote_port (const char* remote_app_id, const char *remote_port, bool *exist)
{
    ...
    return (messageport_error_e)_messageport_check_remote_port (remote_app_id, remote_port, FALSE, exist);
}
...
messageport_check_trusted_remote_port (const char* remote_app_id, const char *remote_port, bool *exist)
{
    ...
    return (messageport_error_e)_messageport_check_remote_port (remote_app_id, remote_port, TRUE, exist);
}
...
messageport_send_message (const char* remote_app_id, const char* remote_port, bundle* message)
{
    ...
    return (messageport_error_e)_messageport_send_message(remote_app_id, remote_port, FALSE, message);
}
...
messageport_send_trusted_message (const char* remote_app_id, const char* remote_port, bundle* message)
{
    ...
    return (messageport_error_e)_messageport_send_message (remote_app_id, remote_port, TRUE, message);
}
...
message_port_unregister_local_port (int local_port_id)
{
    ...
    return (messageport_error_e)res;
}
...
message_port_send_message_with_local_port (const char *remote_app_id, const char *remote_port, bundle *message, int local_port_id)
{
    ...
    return (messageport_error_e)messageport_send_bidirectional_message(local_port_id, remote_app_id, remote_port, message);
}
...
message_port_send_trusted_message_with_local_port (const char* remote_app_id, const char *remote_port, bundle* message, int local_port_id)
{
    ...
    return (messageport_error_e)messageport_send_bidirectional_trusted_message(local_port_id, remote_app_id, remote_port, message);
}
